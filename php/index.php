            ...
            <div class="grid">
                <nav class="header__navbar">
                    ...
                    <ul class="header__navbar-list">
                        ...
                        <li onclick="window.open('register.php')" class="header__navbar-item header__navbar-item--bold header__navbar-item--separate">Đăng ký</li>
                ...
                <div class="header-with-search">
                    ...
                    <form method="GET" action="" enctype="multipart/form-data"  class="header__search">
                        <div class="header__search-input-wrap">
                            <input name="name" type="text" value="<?=isset($_GET["name"]) ? $_GET["name"] : "" ?>" class="header__search-input" placeholder="Tìm kiếm sản phẩm">
                            <!-- Search history -->
...
foreach ($categoryList as $item) {
    ...
    echo'<li class="category-item '.$active.'">
            <a href="index.php?page=1&type='.$item["TYPE"].'" class="category-item__link">'.$item["C_NAME"].'</a>
        </li>';
    $tmp++;
}
?>
...
foreach ($productList as $item) {
    ...
    echo '<div class="grid__column-2-4">
            <a href="detail.php?id='.$item["ID"].'" class="container-product">
                <!-- Product item -->
                <div class="home-product-item">
                    <div class="home-product-item__img" style="background-image: url('.$picture_src.');"></div>
                    <h4 class="home-product-item__name">'.$item["NAME"].'</h4>
                    <span class="home-product-item__price">'.$item["PRICE"].'</span>
                    ...
                    <div class="home-product-item__action">
                        ...
                        <span class="home-product-item__sold">Đã bán 1,5k</span>
                    </div>
                    <div class="home-product-item__origin">
                        <span class="home-product-item__origin-name">'.$item["ORIGIN"].'</span>
                    </div>
                    <div class="home-product-item__mall">Mall</div>
                </div>  
            </a>
        </div>';
}
...
//ham countProduct o showProduct.php
$resuilt= countProduct($type);
$number = 0;

if ($resuilt != null && count($resuilt) > 0) {
    $number = $resuilt[0]['number'];   
}
global $pagination;
$pagination = ceil($number/10);
$type = isset($_GET["type"]) ? $_GET["type"] : 0;
for ($i = 1; $i <= $pagination; $i++) {
    echo'<li class="pagination-item">
            <a href="index.php?page='.$i.'&type='.$type.'" class="pagination-item__link">'.$i.'</a>
        </li>';
}
?>
                        </ul>
    ...
    <script type="text/javascript"> 
        $(".app .container .category ul li a").filter(function() {
            return this.href == location.href.replace(/#.*/,"");
        }).parents("li").addClass("category-item--active")

        $(".app .container .grid__column-10 ul li a").filter(function() {
            return this.href == location.href.replace(/#.*/,"");
        }).parents("li").addClass("pagination-item--active")
